 ...
 * /** Class: ICS 372-01
 * 
 * @author Ian, Kyle, Chelsea, Kevin, based upon code by Brahma Dathan and
 *         Sarnath Ramnath Last modified: 11/27/2015 Project Name: Project #3
 *         Class Name: UIContext Description: A given technology can implement
 *         this to draw the items in its own way.
 *
 */
